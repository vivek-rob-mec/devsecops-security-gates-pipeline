...
CodeQL is useful for semantic/code-query based analysis on supported languages and integrates strongly with GitHub code scanning. For production use, choose supported language matrices and preserve SARIF findings in the security workflow.
